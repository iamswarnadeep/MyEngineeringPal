...
<html lang="en">
  <head>
    ...
    <meta name="Description" content="MyEnggPal installer">
	<meta name="author" content="Ankesh_Nawaj_Swarnadeep">
    <link rel="icon" href="../favicon.ico">

    <title>MyEnggPal installer</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header" style="">
		  ...
		  <a class="navbar-brand" href="#me" style="font-family:Lobster, Tahoma, Arial; color:#b92b27;font-size:25px">MyEnggPal installer</a>
        </div>
...
<div class="row">
	...
	<div class="col-md-9">
		...
		<div class= "page-header">
			<h3>Welcome to MyEnggPal installer script<small class="pull-right">[ Step <?php echo $step; ?> of <?php echo $steps; ?> ]</small></h3>
		</div>
		...
		switch($step) {
				...
				Ready!<br>Now let's break the ice between MyEnggPal and your server ;)
			...
			MyEnggPal uses some open source tools for security, analytics and sharing functions, please follow these steps to properly install them
			...
			?>
			<div style="color:black; font-size:16px">
				Great! Now tell MyEnggPal more about you!<br>
			...
			?>
			<div style="color:black; font-size:16px">
				<h3 style="color:green">Congratulations! You've installed (MyEnggPal) !</h3><br>
