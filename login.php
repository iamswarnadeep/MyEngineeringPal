		...
		?>
					...
					<?php if(isset($_GET['logout']) && $_GET['logout'] == 'true' ) { ?>
						...
						<div class="col-md-6 horizontal-separator">
							<div id="social-login">
								<?php echo "Currently we're not support <u>Login with Google/Facebook</u> , We're working on it..." ?>
								<br>
								<br>
          ...
          <div class="mastfoot ">
            <div class="inner">
              <p><center style="color:white">	Created & Developed by <br><a style="color:white" href="https://www.linkedin.com/in/ankesh-halder-6b5556243/" target="_blank">Ankesh Halder</a>
<br><a style="color:white" href="https://www.linkedin.com/in/sk-nawaj-uddin7878/" target="_blank">Sk Nawaj Uddin</a>
<br><a style="color:white" href="https://www.linkedin.com/in/iamswarnadeep/" target="_blank">Swarnadeep Karmakar</a> </center></p>
            </div>
          </div>
